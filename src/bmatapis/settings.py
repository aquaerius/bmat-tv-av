"""
Django settings for bmatapis project.
...
WSGI_APPLICATION = 'bmatapis.wsgi.application'
...
DATABASES = {
    'default' : {'ENGINE': 'django.db.backends.sqlite3','NAME': os.path.join(BASE_DIR, 'sqlite3.db')}
}
